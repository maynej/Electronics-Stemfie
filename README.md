...
------------- | ------------- | ------------- 
Suport Arduino Nano i tapa |![](Imatges/ArduinoNano.png) | [Arduino Nano](CPU/ArduinoNanoStemfie.stl), [Arduino Nano 2](CPU/ArduinoNano2Stemfie.stl), [Tapa] (CPU/TapaArduinoNanoStemfie.stl)
...
Suport palanca Servo-motor SG9|![](Imatges/Adapter.png) |[Adapter SG9] (SensorsMount/Servo9GAdapter_Stemfie.stl)
...
Suport Sensor Llum LDR|![](Imatges/LDR.png) | [LDR L](SensorsMount/LDRSensorL_mClonSTEMFIEstl), [LDR R](SensorsMount/LDRSensorL_mClonSTEMFIEstl)
